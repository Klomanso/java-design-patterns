...
// This visitor carries out appraisal of employees but takes into consideration performance of team
// as well.
public class AppraisalVisitor implements Visitor {
  ...
  public void visit(ProjectLead lead) {
    // 25% team & 75% personal
    PerformanceRating finalRating =
        new PerformanceRating(lead.getEmployeeId(), lead.getPerformanceRating());
  ...
  public void visit(Manager manager) {
    // 50% team & 50% personal
    PerformanceRating finalRating =
        new PerformanceRating(manager.getEmployeeId(), manager.getPerformanceRating());
  ...
  public void visit(VicePresident vp) {
    // 75% team & 25% personal
    PerformanceRating finalRating =
        new PerformanceRating(vp.getEmployeeId(), vp.getPerformanceRating());
