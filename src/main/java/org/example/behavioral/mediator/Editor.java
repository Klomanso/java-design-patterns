...
/**
 * Concrete mediator. All chaotic communications between concrete components have been extracted to
 * the mediator. Now components only talk with the mediator, which knows who has to handle a
 * request.
 */
